...
public class ExcelUtils implements Closeable{
     ...
     */
    public ExcelUtils(String excelFilePath) throws IOException, InvalidFormatException {
        this.startRow = 0;
     ...
     * @throws InvalidFormatException 非法的格式异常
     */
    public ExcelUtils(InputStream inputStream) throws IOException, InvalidFormatException {
        this.startRow = 0;
        this.sheetName = "Sheet1";
        this.excelFilePath = "";
     ...
     * @throws InvalidFormatException 非法的格式异常
     */
    public ExcelUtils(InputStream inputStream, String outFilePath) throws IOException, InvalidFormatException {
        this.startRow = 0;
        this.sheetName = "Sheet1";
